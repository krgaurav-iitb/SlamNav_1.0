...
public abstract class CalibrationResult {
    ...
    public static void save(Activity activity, Mat cameraMatrix, Mat distortionCoefficients) {
        SharedPreferences sharedPref = activity.getSharedPreferences("com.example.slamNav.CalibrationMatrices", Context.MODE_PRIVATE);
    ...
    public static boolean removeSavedCalibrationResult(Activity activity){
        SharedPreferences sharedPref = activity.getSharedPreferences("com.example.slamNav.CalibrationMatrices", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.clear();
        editor.commit();
